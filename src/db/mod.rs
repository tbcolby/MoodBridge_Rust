...
pub async fn create_pool(database_url: &str) -> Result<DbPool, sqlx::Error> {
    ...
    if !Path::new(db_path).exists() {
        info!(
            "Database file doesn't exist, will be created at: {}",
            db_path
        );
    }
...
=======
        ...
        (
            ...
            "20:00",
            12.0,
            "Father's Day completely denied",
            "Holiday Violation",
            "Denial message",
        ),
        (
...
>>>>>>> fbe419bf3508b585ae5d99d3778d5e6371177856
    ];
    ...
    let timeline_events = vec![
        (
            ...
            "Initial custody arrangements established",
            5,
        ),
        (
            "2023-12-05",
            "agreement",
            "Custody Stipulation Filed",
            "Stipulation establishing placement schedule",
            4,
        ),
        (
            "2024-02-11",
            ...
            "Beginning of documented placement issues",
            5,
        ),
        (
            "2024-02-12",
            "mediation",
            "Mediator Directive Issued",
            "Formal directive regarding placement compliance",
            4,
        ),
        (
            "2024-06-14",
            "violation",
            "Holiday Placement Denied",
            "Complete denial of holiday placement",
            5,
        ),
        (
            "2024-06-26",
            ...
            "Legal action initiated for enforcement",
            5,
        ),
    ];
    ...
    let violations = vec![
        (
            ...
            "Systematic incident pattern begins",
        ...
        (
            "2024-06-14",
            "Holiday Violation",
            "Holiday placement completely denied",
        ...
        (
            "2024-06-26",
            "Compliance Pattern",
            "Ongoing non-compliance with agreements",
            "Multiple sections",
            5,
        ),
    ];
